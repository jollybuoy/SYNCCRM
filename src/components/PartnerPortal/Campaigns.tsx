...
import { customers, manufacturers } from '../../data/sampleData';
                  ...
                  <div key={goal.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {goal.achieved} of {goal.target} {goal.unit}
                      </p>
                    </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-6 mx-4">
                    <div
                      ...
                      style={{
                        width: `${
                          campaign.metrics.customersTargeted
                            ? (campaign.metrics.customersContacted / campaign.metrics.customersTargeted) * 100
                            : 0
                        }%`
                      }}
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-6 mx-4">
                    <div
                      ...
                      style={{
                        width: `${
                          campaign.metrics.customersTargeted
                            ? (campaign.metrics.meetingsScheduled / campaign.metrics.customersTargeted) * 100
                            : 0
                        }%`
                      }}
                    >
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-6 mx-4">
                    <div
                      ...
                      style={{
                        width: `${
                          campaign.metrics.customersTargeted
                            ? (campaign.metrics.opportunitiesCreated / campaign.metrics.customersTargeted) * 100
                            : 0
                        }%`
                      }}
                    >
...
export default function Campaigns() {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: 'Revenue',
      render: (value: any) => (
        <span className="font-medium text-green-600">${(value.revenue / 1_000_000).toFixed(1)}M</span>
      )
    },
    {
      key: 'endDate',
  ...
  return (
    <>
      <div className="p-6 space-y-6">
        ...
        {loading && (
          <Card>
            <div className="py-6 text-gray-600">Loading campaigns…</div>
          </Card>
        )}
        {loadErr && (
          <Card>
            <div className="py-6 text-red-600">Error loading campaigns: {loadErr}</div>
          </Card>
        )}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dbCampaigns.filter(c => c.status === 'active').length}
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dbCampaigns.reduce((sum, c) => sum + (c.metrics.customersTargeted || 0), 0)}
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dbCampaigns.reduce((sum, c) => sum + (c.metrics.meetingsScheduled || 0), 0)}
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {(dbCampaigns.reduce((sum, c) => sum + (c.metrics.revenue || 0), 0) / 1_000_000).toFixed(1)}M
                  </p>
                </div>
              </div>
            </Card>
